...
//    }
    ...
    public void testLoginCRM() {
        ...
        softAssert.assertAll(); //Tổng kết lại tất cả các trường hợp Fail.NÊN khao báo SoftAssert và assertAll ở từng @Test (TCs) để hệ thống chạy báo lỗi chi tiết TCs nào bị lỗi
    }
